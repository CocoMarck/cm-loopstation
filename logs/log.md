...
```bash
linux=x-terminal-emulator --nofork -e
# Ejecuta xterm
...
Lista de archivos: `['README.md', 'config', 'controllers', 'core', 'data', 'docs', 'logs', 'main.py', 'models', 'old', 'requirements.txt', 'resources', 'utils', 'views']`  
